...
@Embeddable
public class ListEmbeddableChild implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ListEmbeddableChild other = (ListEmbeddableChild) obj;
		if (embField1 == null) {
	...
	public String toString() {
		return "ListEmbeddableChild [embField1=" + embField1 + ", embField2=" + embField2 + "]";
	}
